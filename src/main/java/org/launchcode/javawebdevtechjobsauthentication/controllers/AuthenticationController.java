...
public class AuthenticationController {
    ...
    public String processRegForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO,
    ...
    public String processLoginForm(@ModelAttribute @Valid LoginFormDTO loginFormDTO, Errors errors,
        ...
        if (!theUser.isMatchingPassword(password)) {
            errors.rejectValue("password", "password.invalid", "Invalid password for this username.");
            model.addAttribute("title", "Log In");
            return "login";
        }
